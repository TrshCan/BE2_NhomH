 ...
 if(isset($_POST['product_id'])){
    ...
    <head>
        ...
        <link rel="stylesheet" href="../assets/styles/danhgia.css">
        <style>
    ...
    <body>
        <div class="container">
            ...
            <div class="product-info">
                <img src="../assets/images/<?= $product['image_url'] ?>" alt="<?= $product['product_name'] ?>" class="product-image">
...
document.getElementById('submit-review').addEventListener('click', function() {
    ...
    .then(data => {
        if (data.success) {
            ...
            if (data.message.includes('Tên ảnh đã tồn tại')) {
...
notification.style.display = 'none';
    ...
    .catch(error => {
        ...
        setTimeout(() => {
            ...
            console.log('Đã tải xong trang!<?= $product['image_url'] ?>');
        </script>
    </body>
