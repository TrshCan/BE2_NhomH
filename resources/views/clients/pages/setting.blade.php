...
<div class="container mt-5" style="margin-top: 100px;">
    ...
    <div class="tab-content pt-3" id="settingsTabContent">
                    ...
                    <tbody>
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td><span class="address-display" data-address="{{ $order->shipping_address }}">{{ $order->shipping_address }}</span></td>
                                <td>
                                    <button class="btn btn-sm btn-info view-order" data-id="{{ $order->order_id }}" data-bs-toggle="modal" data-bs-target="#viewOrderModal">Xem chi tiết</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="tab-pane fade" id="password" role="tabpanel">
            <div class="alert alert-warning">Chức năng đổi mật khẩu hiện tại chưa được kích hoạt. Vui lòng liên hệ quản trị viên.</div>
