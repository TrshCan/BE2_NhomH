            ...
            <div class="row product_section">
                ...
                <aside class="col-lg-3 sidebar">
                    ...
                    @foreach ($categories as $item)
                               <li>
                                   <input type="checkbox" id="category-headsets" class="custom-checkbox">
                                   <label for="category-headsets" class="ms-2">{{$item->category_name}}</label>
                               </li>
                    @endforeach
                    ...
                    <div class="sidebar_section mb-4 filter-card">
                        ...
                        <ul class="checkboxes list-unstyled price-list">
                            ...
                            <li>
                                ...
                                <label for="price1" class="ms-2">$0 - $100</label>
                            </li>
                            <li>
                                <input type="checkbox" id="price2" class="custom-checkbox">
                                <label for="price2" class="ms-2">$100 - $500</label>
                            </li>
                            <li>
                                <input type="checkbox" id="price3" class="custom-checkbox">
                                <label for="price3" class="ms-2">$500 - $1000</label>
                            </li>
                            <li class="hidden-item">
                                <input type="checkbox" id="price4" class="custom-checkbox">
                                <label for="price4" class="ms-2">$1000 - $1500</label>
                            </li>
                        </ul>
                        ...
                        <div class="price-range-filter mt-3">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <input type="number" id="price-min" class="form-control me-2" placeholder="Min" min="0"
                                    step="1">
                                <span>-</span>
                                <input type="number" id="price-max" class="form-control ms-2" placeholder="Max" min="0"
                                    step="1">
                            </div>
                    ...
                    <div class="sidebar_section filter-card">
                        ...
                        <ul class="checkboxes list-unstyled brand-list">
                            @foreach ($brands as $item1)
                                 <li>
                                <input type="checkbox" id="brand-jbl" class="custom-checkbox">
                                <label for="brand-jbl" class="ms-2">{{$item1->name}}</label>
                            </li>
                            @endforeach
                    ...
                    <div class="products_iso">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu sorting_type">
                                    <li class="type_sorting_btn" data-isotope-option='{ "sortBy": "original-order" }'><a
                                            class="dropdown-item" href="#">Lọc</a></li>
                        ...
                        <div class="product-grid row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                            @foreach ($products as $item2)
                                 <div class="col product-item headsets">
                                <div class="card product discount product_filter h-100">
                                    ...
                                    <div class="card-body product_info text-center">
                                        ...
                                        <div class="product_price">{{$item2->price}} <span></span></div>
                                    </div>
                        ...
                        <div
                            ...
                            <span class="showing_results">Showing 1–12 of 12 results</span>
                            <div class="d-flex align-items-center">
                                <div class="dropdown me-2">
                                    <button class="btn btn-outline-secondary dropdown-toggle" type="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <nav aria-label="Page navigation" class="pages">
                                    <ul class="pagination mb-0">
                                        <li class="page-item page_current active"><a class="page-link" href="#">1</a>
                                        </li>
