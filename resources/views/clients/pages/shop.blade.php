    ...
    <div class="row product_section">
      ...
      <aside class="col-lg-3 sidebar">
        <div class="sidebar_section mb-4 filter-card">
          ...
          <a href="{{ route('products.index', [$brandSlug, null]) }}" class="btn btn-outline-secondary btn-sm mt-2">Xóa bộ lọc danh mục</a>
        </div>
        ...
        <div class="sidebar_section mb-4 filter-card">
          ...
          <div class="price-range-filter mt-3">
            ...
            <div class="d-flex align-items-center mb-2">
              <input type="number" id="price-min" class="form-control me-2" placeholder="Tối thiểu" min="0" step="100000">
              <span>-</span>
              <input type="number" id="price-max" class="form-control ms-2" placeholder="Tối đa" min="0" step="100000">
            </div>
        ...
        <div class="sidebar_section filter-card">
          ...
          <a href="{{ route('products.index', [null, $categorySlug]) }}" class="btn btn-outline-secondary btn-sm mt-2">Xóa bộ lọc thương hiệu</a>
        </div>
      </aside>
