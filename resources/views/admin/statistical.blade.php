...
<script>
    ...
    // Sử dụng flatpickr để kiểm tra định dạng ngày
    const fromDateObj = flatpickr.parseDate(fromDateInput, "d/m/Y");
    const toDateObj = flatpickr.parseDate(toDateInput, "d/m/Y");
