...
<div class="container">
    ...
    <!-- Search Form -->
    <form method="GET" action="{{ route('user.list') }}" class="mb-3 d-flex flex-column flex-md-row gap-2">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex flex-column flex-md-row gap-2 justify-content-center">
                            <a href="{{ route('user.postUpdateUser', $user->id) }}" class="btn btn-warning btn-sm w-100">Sửa</a>
